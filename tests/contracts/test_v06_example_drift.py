"""v0.7 합성 예시의 결정론적 생성 결과 drift 검사."""
...
COMMITTED = ROOT / "docs/examples/v0.7/synthetic"


def test_v07_synthetic_examples_match_fresh_generation(tmp_path: Path) -> None:
    ...
    subprocess.run(
        [
            sys.executable,
            str(ROOT / "scripts/generate_v07_synthetic_examples.py"),
            "--output",
            str(generated),
        ],
        cwd=ROOT,
